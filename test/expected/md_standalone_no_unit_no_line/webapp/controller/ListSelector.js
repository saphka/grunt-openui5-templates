sap.ui.define([
		...
		return BaseObject.extend("md.standalone.no.unit.no.line.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias md.standalone.no.unit.no.line.model.ListSelector
			 */
			 ...
			 * @return {md.standalone.no.unit.no.line.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
