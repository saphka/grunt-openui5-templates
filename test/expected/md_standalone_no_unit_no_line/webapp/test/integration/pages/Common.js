sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("md/standalone/no/unit/no/line/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("md.standalone.no.unit.no.line.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["md/standalone/no/unit/no/line/localService/mockserver"], function (mockserver) {
