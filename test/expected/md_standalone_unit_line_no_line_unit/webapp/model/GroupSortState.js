sap.ui.define([
	...
	return BaseObject.extend("md.standalone.unit.line.no.line.unit.model.GroupSortState", {
		 ...
		 * @alias md.standalone.unit.line.no.line.unit.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Description, or by Rating
		 *
		...
		/**
		 * Groups by Rating, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "Rating") {
				...
				this._oViewModel.setProperty("/sortBy", "Rating");

				aSorters.push(
					new Sorter("Rating", false,
