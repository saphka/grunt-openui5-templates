...
sap.ui.require([
	...
	sap.ui.require([
		"md/standalone/unit/no/line/test/integration/MasterJourney",
		"md/standalone/unit/no/line/test/integration/NavigationJourney",
		"md/standalone/unit/no/line/test/integration/NotFoundJourney",
		"md/standalone/unit/no/line/test/integration/BusyJourney"
	], function () {
		QUnit.start();
	});
});