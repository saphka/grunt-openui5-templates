sap.ui.define([
		...
		return BaseObject.extend("md.standalone.unit.no.line.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias md.standalone.unit.no.line.model.ListSelector
			 */
			 ...
			 * @return {md.standalone.unit.no.line.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
