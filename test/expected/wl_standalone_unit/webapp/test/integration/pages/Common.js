sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("standalone/unit/app", ".html");
		...
		return Opa5.extend("standalone.unit.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["standalone/unit/localService/mockserver"], function (mockserver) {
