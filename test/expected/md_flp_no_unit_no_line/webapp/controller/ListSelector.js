sap.ui.define([
		...
		return BaseObject.extend("md.flp.no.unit.no.line.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias md.flp.no.unit.no.line.model.ListSelector
			 */
			 ...
			 * @return {md.flp.no.unit.no.line.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
