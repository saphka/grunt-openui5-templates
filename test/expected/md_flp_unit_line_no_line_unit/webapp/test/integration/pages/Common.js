sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("md/flp/unit/line/no/line/unit/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#md_flp_unit_line_no_line_unit-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#md_flp_unit_line_no_line_unit-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("md.flp.unit.line.no.line.unit.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["md/flp/unit/line/no/line/unit/localService/mockserver"], function (mockserver) {
