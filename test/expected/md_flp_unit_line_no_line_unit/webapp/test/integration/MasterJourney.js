sap.ui.define([
		...
		opaTest("MasterList Filtering on Rating less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Rating>").
				and.iSelectListItemInViewSettingsDialog("<100 <Price>").
		...
		opaTest("MasterList Filtering on Rating more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Price>").
				and.iPressOKInViewSelectionDialog();
