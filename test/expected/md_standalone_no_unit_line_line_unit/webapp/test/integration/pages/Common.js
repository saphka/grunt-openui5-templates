sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("md/standalone/no/unit/line/line/unit/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("md.standalone.no.unit.line.line.unit.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["md/standalone/no/unit/line/line/unit/localService/mockserver"], function (mockserver) {
